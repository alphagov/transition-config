...
#   Failed test 'Old Url [http://example.com/fragid\#OldUrlFragmentIdenfierMakesNoSense] is not canonical [http://example.com/fragid\#oldurlfragmentidenfiermakesnosense] /tmp/validate.in line 11'
#          got: 'http://example.com/fragid#OldUrlFragmentIdenfierMakesNoSense'
#     expected: 'http://example.com/fragid#oldurlfragmentidenfiermakesnosense'
