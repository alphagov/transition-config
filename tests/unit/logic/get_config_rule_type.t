...
my $config_rule_type   = Mappings::Rules::get_config_rule_type( undef, $test_url_parts->{host} );
...
$config_rule_type   = Mappings::Rules::get_config_rule_type( undef, $test_url_parts->{host} );
