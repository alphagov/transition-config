...
is( $error_status, $response_code, "blackpoolunlimited homepage is not handled by the redirector" );
...
is( $error_status, $response_code, "actual blackpoolunlimited homepage is not handled by the redirector" );
...
is( $error_status, $response_code, "A sample blackpoolunlimited page is not handled by the redirector" );
