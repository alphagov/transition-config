...
my %expected = (
        ...
        'www.businesslink.gov.uk' => {
            ...
            'suggested_links_map' => qq(\$query_suggested_links['topicId=1073858783'] = "<li><a href='http://www.hmrc.gov.uk'>HMRC</a></li><li><a href='http://www.number10.gov.uk/'>number10.gov.uk</a></li>";\n),
        },
    );
