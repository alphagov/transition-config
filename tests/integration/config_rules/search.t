...
( $response_code, $redirect_location) = get_response ( 'http://www.direct.gov.uk/en/AdvancedSearch/top100/DG_072883' );
is( '301', $response_code, "Directgov top 100 searches page redirects" );
is( 'https://www.gov.uk/search', $redirect_location, "redirect is to  https://www.gov.uk/search" );
