...
my $row = { 
	'Old Url'	=> 'http://www.businesslink.gov.uk/bdotg/action/layer?=en&itemId=1081128808&lang=en&topicId=1081128739&type=RESOURCES',
	'New Url'	=> 'https://www.gov.uk/get-information-about-a-company',
	'Status'	=> 301,
	'Whole Tag'	=> 'Closed',
}; 
my $rules = Mappings::Rules->new( $row );
my ( $host, $map, $config_line )  = $rules->actual_nginx_config();
is ( $map, "redirect_map", "A map key derived from the query string for a 301 is added to the redirect map");
is ( $config_line, "~topicId=1081128739 https://www.gov.uk/get-information-about-a-company;\n", "Map key is correct");
...
# my $result_key   = Mappings::Businesslink::get_url_key( undef, $test_url_parts );
...
# $result_key   = Mappings::Businesslink::get_url_key( undef, $test_url_parts );
